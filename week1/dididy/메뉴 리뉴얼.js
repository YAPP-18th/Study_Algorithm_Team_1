...
## How
알고리즘을 이용해 최적화를 하는 문제는 아니었다. 각 주문에 대한 조합을 만들고 해당 조합이 몇번 나왔는지를 파악해서 2번 이상 주문된 경우 course의 수에 맞는 조합을 출력하면 된다.

그냥 객체를 하나 만들어서 주문된 메뉴들의 course 수에 해당하는 조합을 구해 객체에 key로 넣고 value로 몇번 반복되는지 파악했다.

그리고는 course의 수에 맞게 가장 많이 주문되고 2번 이상 주문된 메뉴를 배열에 넣어 정렬하여 출력할 수 있도록 하였다.
